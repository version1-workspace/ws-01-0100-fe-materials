...
describe("merge", () => {
  test("normal", () => {
    expect(merge([1, 2, 3, 4, 5], [4, 5, 6, 7, 8])).toEqual([
      1,
      2,
      3,
      4,
    ...
    expect(
      merge(
        ...
        ["grape", "kiwi", "pineapple", "watermelon"]
      )
    ).toEqual([
      "apple",
      "banana",
...
describe("mergeObjOfArray", () => {
  test("normal", () => {
    ...
    expect(mergeObjOfArray([], [])).toEqual([]);
  });
});
...
describe("sum", () => {
  test("normal", () => {
    ...
    expect(sum([{ count: 1 }, { count: 2 }, { count: 3 }])).toEqual(6);
    expect(
      sum([
        { count: 1, a: [{ count: 2 }, { count: 3 }], b: { count: 4 } },
        { count: 5 }
      ])
    ).toEqual(15);
    expect(sum([{ count: 1, a: { b: { c: { d: { count: 1 } } } } }])).toEqual(
      2
    );
  });
});
